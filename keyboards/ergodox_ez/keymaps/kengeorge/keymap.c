 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | Grave  |   1  |   2  |   3  |   4  |   5  |CtrlZ |           | CAPS |   6  |   7  |   8  |   9  |   0  |   =    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , CTL_Z  ,
...
[SYM] = LAYOUT_ergodox(
        ...
        _______, KC_PIPE, KC_AMPR, KC_LBRC, KC_RBRC, KC_EQL , _______,
        ...
        _______, KC_ASTR, KC_7   , KC_8   , KC_9   , SH_TAB , KC_F12 ,
                 KC_MINS, KC_4   , KC_5   , KC_6   , _______, _______,
        _______, KC_PLUS, KC_1   , KC_2   , KC_3   , KC_TAB , _______,
                          KC_COMM, KC_0   , KC_DOT , _______, _______,
        _______, _______,
        _______,
        _______, _______, _______
),
...
[NAV] = LAYOUT_ergodox(
       ...
       _______, CMD_Z  , CMD_X  , CMD_C  , CMD_V  , CMD_B  , _______,
       _______, _______, _______, _______, _______,
                                                    KC_BTN3, KC_WH_U,
                                                             KC_WH_D,
